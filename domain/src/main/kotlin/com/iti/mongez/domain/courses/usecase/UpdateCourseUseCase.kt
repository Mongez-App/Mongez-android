...
class UpdateCourseUseCase @Inject constructor(
    ...
    suspend operator fun invoke(courseId: String, name: String, isHidden: Boolean): Result<CourseActionResponse<Course>> {
        return coursesRepository.updateCourse(courseId, name, isHidden)
    }
}
